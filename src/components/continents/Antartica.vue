<template>
    ...
    var config = {
      method: "get",
      url:'https://restcountries.com/v2/region/Oceania',
      headers: {
    ...
    console.log("Oceania",  this.africanCountries)
      })
    ...
    initDealCarrousel('va_containerArt'); //carrousel ID
        },
        methods: {
            devisForm(country){
