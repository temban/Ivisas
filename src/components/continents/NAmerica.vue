      ...
      <div class="va-carrousel-section" >
        <div class="va-whitewrap">
            ...
            top: 3rem; left:0px;     background-color:#ffffff5d;width:18rem;">
                        <h3  style="font-size:1.8rem; font-weight: 700; margin-left: 0.9rem; text-shadow: 5px 5px 10px #a07a2a ;
">
    ...
    var config = {
      method: "get",
      url:'https://restcountries.com/v3.1/region/North America',
      headers: {
    ...
    console.log("paiy",  this.africanCountries)
      })
    ...
    initDealCarrousel('va_containerNA'); //carrousel ID
        },
        methods: {
          devisForm(country){
   localStorage.setItem("selected_country", country)
    ...
    .Card2:hover a{top: 0px;}
      ...
      .link-plain,
          ...
          .va-carrousel-flexbox .Card2 {
              flex: 0 0 auto;
              padding-left: 15px;
          }
      
          .va-carrousel-flexbox .Card2:last-child {
              margin-right: 15px;
          }
      
          .va-carrousel-flexbox .Card2:last-child::after {
              content: ' ';
              display: inline-block;
          }
