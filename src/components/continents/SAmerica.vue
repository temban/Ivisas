<template>
    ...
    var config = {
      method: "get",
      url:'https://restcountries.com/v3.1/subregion/South America',
      headers: {
    ...
    console.log("America",  this.africanCountries)
      })
    ...
    initDealCarrousel('va_containerSA'); //carrousel ID
        },
        methods: {
          devisForm(country){
