<template>
    ...
    var config = {
      method: "get",
      url:'https://restcountries.com/v2/region/Europe',
      headers: {
    ...
    console.log("Europe",  this.africanCountries)
      })
    ...
    initDealCarrousel('va_containerEurope'); //carrousel ID
        },
        methods: {
