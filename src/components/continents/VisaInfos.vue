<template>
  <div
    style="
      background: linear-gradient(#e2e0e0, #363636, #070303);
    ...
    <div class="tm-container-outer" id="tm-section-2">
      <section class="tm-slideshow-section">
        <div class="tm-slideshow">
          <img src="@/assets/img/world1.png" alt="Image" />
        </div>
        <div class="tm-slideshow-description tm-bg-primary">
          <h1 style="font-size: 2rem; font-weight: 700">Besoin d'un Visa?</h1>
          <p style="font-size: 1.2rem; font-weight: 500; margin-bottom: 10px; ">
            - Démarches en ligne pour l'obtention du droit d'entrée sur son
            territoire, nous vous accompagnons.
          </p>
          ...
          <p style="font-size: 1.2rem; font-weight: 500; margin-bottom: 10px">
            - Evitez les tracas de l'ambassade, confiez nous vos démarches.
          </p>
...
.goldButton img{
    max-width:35%; 
    border-radius: 10px;
    box-shadow: 2px 2px 5px rgba(142, 138, 138, 0.872);
