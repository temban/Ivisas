      ...
      <div
              style="
                ...
                border-radius: 30px 30px 0 0;
                    background: linear-gradient(#e2e0e08d, #e2e0e06e);
              "
            >
                    <div 
                      class="col-xs-12 mx-auto tm-about-text-wrap text-center"
                    >            <div class="controls">
  <div >
    <input class="sliderBox mt-4 mb-3" id="range" type="range" name="font-size" min=".6" max="1.5" value="1" step=".1" data-units="rem" />
  </div>
</div>
                      <h2
      ...
      <ul class="nav nav-pills tm-tabs-links" style="  max-width: 100%;
">
        <li class="tm-tab-link-li">
          <a href="#1a" data-toggle="tab" class="tm-tab-link">
            <img
              src="@/assets/img/north-america.png"
              alt="Image"
              class="img-fluid"
            />
            North America
        ...
        <li class="tm-tab-link-li">
          <a href="#2a" data-toggle="tab" class="tm-tab-link">
            <img
              src="@/assets/img/south-america.png"
              alt="Image"
              class="img-fluid"
            />
            South America
        ...
        <li class="tm-tab-link-li">
          <a href="#3a" data-toggle="tab" class="tm-tab-link">
            <img src="@/assets/img/europe.png" alt="Image" class="img-fluid" />
            Europe
          </a>
        </li>
        <li class="tm-tab-link-li">
          <a href="#4a" data-toggle="tab" class="tm-tab-link active"
            ><!-- Current Active Tab -->
            <img src="@/assets/img/asia.png" alt="Image" class="img-fluid" />
            Asia
          </a>
        </li>
        <li class="tm-tab-link-li">
          <a href="#5a" data-toggle="tab" class="tm-tab-link">
            <img src="@/assets/img/africa.png" alt="Image" class="img-fluid" />
            Africa
          </a>
        </li>
        <li class="tm-tab-link-li">
...
import VisasVue from "./VisaSteps.vue";
import NAmericaVue from "./continents/NAmerica.vue";
import SAmericaVue from "./continents/SAmerica.vue";
import AfricanVue from "./continents/African.vue";
import AsiaVue from "./continents/Asia.vue";
import AustraliaVue from "./continents/Australia.vue";
import EuropeVue from "./continents/Europe.vue";
import AntarticaVue from "./continents/Antartica.vue";
export default {
  name: "NAmerica",
  data() {
    return {};
...
.footer {
  ...
  background: linear-gradient(217deg, #3d3d3d, #363636),
    linear-gradient(127deg, #0f0a0a, #070303 70.71%),
    linear-gradient(336deg, #3d3d3d, #363636 70.71%);
}

.copy-right {
  text-align: center;
  padding: 10px 0px;
  background: linear-gradient(217deg, #2e2e2e, #282828);
}
