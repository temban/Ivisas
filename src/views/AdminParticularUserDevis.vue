        ...
        <main class="py-6 bg-surface-secondary">
          ...
          >
                        ...
                        <table class="table table-hover table-nowrap">
                            ...
                            <tbody  v-for="devi in devis" :key="devi.id">
                                <tr >
                                    ...
                                    <td v-if="devi.adminDevisDao.length === 0"><a
            ...
            ></td>
                                    ...
                                    <td class="text-end">
                                      <a  @click="pdfAvis(devi)" class="btn btn-sm btn-danger mr-2">pdf</a>
...
.then((response) => {
  ...
  console.log("ddddddddd", this.devis)
...
pdfAvis(devi){
  localStorage.setItem("adminDeviId", devi.id);
window.location.href="/PdfGenarateDevi"
},
        user(){
          var axios = require('axios').default;
...
axios(config)
.then((response) => {
  this.pUserPhoto = response.data.profileImage;
          this.pUserName = response.data.name;
          this.pUserEmail = response.data.email;
...
this.checkAvis = res.data.adminDevisDao;
  ...
  console.log("sssssssssssss", this.paymentMethod );
})
.catch(function (error) {
  console.log(error);
});
