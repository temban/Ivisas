         ...
         <div class="col-md-8 border-right">
           ...
           <span class="font-weight-bold">{{ this.pUserName}}</span
             ...
             ><span> </span>
               ...
               <h4 class="text-center mx-4">Demande de devis</h4>
             ...
             <div class="row mt-3">
               ...
               <div class="col-md-12">
                 ...
                 <div class="input_field checkbox_option">
                   ...
                   />
                   <label for="Tourisme11">Tourisme</label>
                   <input readonly
                     type="radio"  onclick="javascript: return false;"
                     ...
                     v-model="travelReason"
                   />
                   <label for="o11">Visite officielle </label>
               ...
               <div class="col-md-12">
                 <div class="input_field checkbox_option">
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="Sports11">Sports</label>
                   ...
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="Transit11">Transit aéroportuaire</label>
                 </div>
               </div>
               ...
               <div class="col-md-12">
                 <div class="input_field checkbox_option">
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="raison11">Raisons médicales</label>
                   ...
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="Affaires11">Affaires </label>
               ...
               <div class="col-md-12">
                 <div class="input_field checkbox_option">
                     ...
                     v-model="travelReason"
                   />
                   <label for="Études11">Études</label>
                   ...
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="Culture11">Culture</label>
               ...
               <div class="col-md-12">
                 <div class="input_field checkbox_option">
                   ...
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="visit11">Visite à la famille ou à des amis</label>
                 </div>
               </div>
               ...
               <div class="col-md-12">
                 <div class="input_field checkbox_option">
                   ...
                   <input readonly
                     ...
                     v-model="travelReason"
                   />
                   <label for="autre11">Autre (à préciser)</label>
               ...
               <div class="col-md-12">
                 ...
                 <div class="input_field checkbox_option">
                    ...
                    <input readonly
                      ...
                      v-model="supportDocument"
                    />
                    <label for="Incomplet1">Incomplet</label>
                    ...
                    <input readonly
                      ...
                      v-model="supportDocument"
                    />
                    <label for="attente1">En attente</label>
