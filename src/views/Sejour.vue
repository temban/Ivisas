...
<div style="font-family: 'Open Sans', Helvetica, Arial, sans-serif;
  ...
  border-radius: 30px 30px 0 0;">
   <section class="p-5 tm-container-outer tm-container-outer" style=" background:  linear-gradient(#a2a2a2, #e2e0e0); border-radius: 30px 30px 0 0;">            
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 mx-auto tm-about-text-wrap text-center">                        
                            <h2 class="text-uppercase mb-2" style="font-size:1.8rem; font-weight:900">SEJOUR COMPLET</h2>
                            <p class="mb-4" style="font-size:1.1rem;">Vous voyagez une semaine ? Vous voyagez avec un petit budget ? 
                              Vous voyagez en Europe ? Vous voyagez avec des enfants ? 
                              Vous voyagez seul ? 
                              Vous voyagez en famille</p>
                            
                              <h2 class="text-uppercase mb-2" style="font-size:1.3rem; font-weight:900">IVISAS-AFFAIRES vous propose un service complet</h2>
                            <p class="mb-4" style="font-size:1.1rem;">visas, 
billet d'avion, 
hotel, 
chauffeur, 
...
un offre est actuellement ouverte, profitez-en . </p>
  ...
  <script>
  import SejourInfoVue from '../components/SejourInfo.vue';
  import navSejourVue from '../components/navbars/navSejour.vue';
  export default {
    name: "Sejour",
    data() {
      return {};
...
.tm-container-outer { background-color: #efefef; }
