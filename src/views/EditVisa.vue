...
<div class="button1">
  <button class="button" type="button" @click="updateVisa()" value="Envoyer" >Envoyer  
...
var config = {
  method: "get",
  url: this.$url + "/order/visa?id="+ localStorage.getItem("editVisaId"),
  headers: {
...
var config = {
  method: 'put',
  url:  this.$url+'/update/order/visa',
  headers: { 
    'Content-Type': 'application/json', 
    'Authorization': 'Bearer ' + localStorage.getItem('access-token')
  },
