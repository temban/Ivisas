...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
          ...
          <div class="collapse navbar-collapse" id="sidebarCollapse">
           ...
           <li class="nav-item">
               <a class="nav-link" href="#">
                ...
                <!-- User (md) -->
                <ul class="navbar-nav">
                      <button type="button" class="nav-link" @click="singout()" style="cursor: pointer; max-width: 100%;">
                ...
                <div class="mb-npx">
                    <div class="row align-items-center">
                        <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                            <!-- Title -->
                            <h1 class="h2 mb-0 ls-tight">Mes Demandes des devis</h1>
                        </div>
                        <!-- Actions -->
                    ...
                    <ul class="nav nav-tabs mt-4 overflow-x border-0 ">
                        <router-link to="/UserDashboard"><li class="nav-item ">
                            <a  class="nav-link">Tableau de bord</a>
                        </li>
                    </router-link>
                        <li class="nav-item mx-4">
                            <a  class="nav-link active">Mes Demandes des devis</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script>
    import UserAllDevisVue from '../components/UserAllDevis.vue';
    export default {
      name: "UserAllDevis",
      data() {
        return {
